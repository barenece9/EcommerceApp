...
public class WishItemIO {
	...
	// constructor
	public WishItemIO(int id, int _product_id, String name, String _unit_price){
		this._id = id;
	...
	// constructor
	public WishItemIO(int _product_id, String name, String _unit_price){
		this._product_id=_product_id;
		this._name = name;
		this._unit_price = _unit_price;
	}
