...
public class CustomColorAdapter extends ArrayAdapter<CustomData> {
    private LayoutInflater mInflater;

    public CustomColorAdapter(Context context, CustomData[] values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // holder.btn_size.setText(getItem(position).getText());
        ...
        // Set the color
        holder.btn_size.setBackgroundColor(getItem(position).getBackgroundColor());
